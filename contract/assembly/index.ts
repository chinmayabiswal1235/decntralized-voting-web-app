// Smart Contact for Block development and deployment
...
// Pulls and reads infoemation from blockchain

export function getUrl(name:string):string{
  if(CandidateURL.contains(name)){
    return CandidateURL.getSome(name)
  }else {
    logging.log('cannot find that user');
    return '';
  }
}
